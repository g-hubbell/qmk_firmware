...
[_MOUSE] = LAYOUT_split_3x5_3(KC_UNDO,KC_CUT, KC_COPY, KC_PASTE, KC_AGAIN,                               KC_NO, CPI_MACOS,CPI_DEFAULT,KC_NO, QK_BOOT,
                              KC_NO, KC_NO ,KC_NO, FAST_SCROLL_MODE, KC_NO,                             KC_NO, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
                             KC_NO, KC_NO,KC_BTN2, KC_BTN1, KC_NO,                              CG_SWAP, CG_NORM, KC_NO, KC_NO, OSL(_BUTTON),
...
*/
[_SYM] = LAYOUT_split_3x5_3(S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5),                                KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
                            S(KC_6), S(KC_7), S(KC_8), S(KC_9),S(KC_0),                              KC_NO, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
                            S(KC_LBRC),S(KC_RBRC),S(KC_EQL), S(KC_BSLS), S(KC_GRV),                             KC_NO, KC_NO, KC_NO, KC_NO, OSL(_BUTTON),
                                        PARENTHESIS, S(KC_SCLN), S(KC_MINS),                                KC_NO, KC_NO),

[_NUM] = LAYOUT_split_3x5_3(KC_1, KC_2, KC_3, KC_4, KC_5,                                KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
