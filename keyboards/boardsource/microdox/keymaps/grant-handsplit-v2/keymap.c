...
MT(MOD_LGUI, KC_A), MT(MOD_LALT,KC_S), MT(MOD_LCTL, KC_D), MT(MOD_LSFT,KC_F), KC_G, 	                            KC_H, MT(MOD_LSFT,KC_J), MT(MOD_LCTL,KC_K), MT(MOD_LALT,KC_L), MT(MOD_LGUI, KC_SCLN),
								                        ...
								                        OSL(6), KC_LSFT, LT(1,KC_ENT), 						    LT(2,KC_BSPC), KC_SPC, KC_LALT),
...
[_LAYER6] = LAYOUT_split_3x5_3(         KC_Q, KC_W, KC_E, KC_R, LCTL(KC_T),							    LCTL(KC_Y), KC_U, LCTL(KC_I), KC_O, KC_P,
                            LCTL(KC_A), LCTL(KC_S), KC_D, LCTL(KC_F), KC_G, 	                        LCTL(KC_H), KC_J, KC_K, KC_L, KC_SCLN,
                LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), LCTL(KC_B), 							LCTL(KC_N), KC_M, KC_COMM, KC_DOT, KC_SLSH,
