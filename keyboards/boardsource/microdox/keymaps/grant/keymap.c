...
#define _LAYER8 8
 ...
 [_LAYER0] = LAYOUT_split_3x5_3(KC_Q, KC_W, KC_E, KC_R, KC_T,							             KC_Y, KC_U, KC_I, KC_O, KC_P, 
 								KC_A, LT(6,KC_S), LT(8,KC_D), LT(3,KC_F), KC_G, 		             KC_H, LT(4,KC_J), LT(5,KC_K), LT(9,KC_L), LT(7,KC_SCLN), 
...
[_LAYER2] = LAYOUT_split_3x5_3(KC_TAB, KC_NO, KC_NO, KC_NO, KC_NO,                                      KC_NO, KC_NO, LCTL(LSFT(KC_I)), KC_NO, KC_NO,
                               KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                       KC_NO, KC_NO, KC_NO, KC_DQUO, KC_QUOT,
                               KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                       KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
                                            KC_NO, KC_NO, KC_NO,                                        KC_NO, KC_NO, KC_NO),

[_LAYER3] = LAYOUT_split_3x5_3(KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO,                                     KC_NO, KC_NO, KC_UP, KC_NO, KC_NO,
                               KC_TRNS, KC_TRNS, KC_LCTL, KC_NO, KC_LALT,                               KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,
...
[_LAYER8] = LAYOUT_split_3x5_3(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                       KC_NO, KC_7, KC_8, KC_9, KC_NO,
